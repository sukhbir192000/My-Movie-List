 ...
 * @author Puneet
 */
@WebServlet(name = "SendFriendRequestController", urlPatterns = {"/SendFriendRequestController"})
public class SendFriendRequestController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Reached here add");
        try {
            ...
            friendRequestDao.sendFriendRequest((long)statusToUpdate.get("userId"), (long)statusToUpdate.get("visitorId"));
