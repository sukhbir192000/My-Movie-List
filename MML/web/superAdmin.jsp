            ...
            <div id="sidebar"
                ...
                <div class="d-flex flex-column sidebar_color p-0  ">
                    <div class="p-0 w-100 m-0">
                        ...
                        <a href="./manageCarousel.html"
                            class="list-group-item content_color mt-3 ps-4 border border-dark active_color">
                            Manage Carousel
                        </a>
                        <a href="./manageUsers.html" class="list-group-item content_color ps-4 border border-dark">
                            Manage Users
                        </a>
                        <a href="./manageReviews.html" class="list-group-item content_color ps-4 border border-dark">
                            Manage Reviews
                        </a>
                        <a href="./stats.html" class="list-group-item content_color ps-4 border border-dark">
                            Stats
                        </a>
